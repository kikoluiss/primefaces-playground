CREATE DATABASE db_primefaces_playground;

CREATE TABLE db_primefaces_playground.tb_usuario(
...
CREATE TABLE db_primefaces_playground.tb_pessoa(
...
ALTER TABLE db_primefaces_playground.tb_pessoa ADD FOREIGN KEY (id_usuario_cadastro) REFERENCES db_primefaces_playground.tb_usuario(id_usuario);

INSERT INTO db_primefaces_playground.tb_usuario (ds_login,ds_senha) VALUES('admin','123456');
